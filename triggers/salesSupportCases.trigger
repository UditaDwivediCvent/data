    ...
    for(Case c : Trigger.new){
        if(c.RecordTypeId=='012o0000000oWbY'){                             //Check if the case is of Support Sales Cases record type
            if(Trigger.isInsert){
                ...
                if(c.Product_Type__c=='SMM MRF/Workflow/HCP' && c.Request_Type__c!='Strategic Support')
                    c.Product_Type__c = 'Event Blue';
                
                if(c.Product_Type__c=='CSN - Planner' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G00000006w2R0';                                 // assign the case to Client Services Case Queue - CSN Planner
                    //c.RecordTypeId = '0120000000099RR';
                }
            
                else if(c.Product_Type__c=='Genie Connect' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G1N000002aXXZ';                                 // assign the case to Case Queue - Genie Connect
                    //c.RecordTypeId = '0120000000099RR';   
                }

                else if(c.Product_Type__c=='RegOnline' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G1N000002aXXc';                                 // assign the case to Client Services Case Queue - RegOnline
                    //c.RecordTypeId = '0120000000099RR';   
                }

                else if((c.Product_Type__c=='Meetings'||c.Product_Type__c=='Group') && c.Request_Type__c!='Strategic Support'){
                ...
                else if(c.Product_Type__c=='Business Transient' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G1N000002ziG2';                                 // assign the case to Client Services Case Queue - Travel
                    //c.RecordTypeId = '0120000000099RR';   
                }
                
                else if(c.Product_Type__c=='Passkey' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G1N000002aXXb';                                 // assign the case to Client Services Case Queue - Travel
                    //c.RecordTypeId = '0120000000099RR';   
                }

                else if(c.Product_Type__c=='Travel' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G1N000002ziG2';                                 // assign the case to Client Services Case Queue - Travel
                    //c.RecordTypeId = '0120000000099RR';   
                }
                ...
                else if(c.Product_Type__c=='CSN - Supplier' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G00000006w2Qz';                                // assign the case to Client Services Case Queue - CSNSupplier
                    //c.RecordTypeId = '0120000000099RS';
                }    
                else if(c.Product_Type__c=='eMarketing' && c.Request_Type__c!='Strategic Support'){
                ...
                //else if(c.Product_Type__c=='Event Blue' && c.Request_Type__c!='Strategic Support'){
                ...
                || c.Product_Type__c=='Data Services' || c.Product_Type__c=='Integration' || c.Product_Type__c=='LeadCapture' || c.Product_Type__c=='Lead Scoring' 
                || c.Product_Type__c=='SMM' || c.Product_Type__c=='SocialWall' ) && c.Request_Type__c!='Strategic Support'){
                    // onarrival product type too
                    c.ownerid = '00G00000006w2R1';                                // assign the case to Client Services Case Queue - Event
                    //c.RecordTypeId = '0120000000099RV';
                }
                else if(c.Product_Type__c=='Surveys' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G00000006w2R3';                                // assign the case to Client Services Case Queue - Surveys         
                    //c.RecordTypeId = '0120000000099RW';
                }
                else if(c.Product_Type__c=='CrowdCompass' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G00000006vs24';                                // assign the case to Crowd Compass Support
                    //c.RecordTypeId = '0120000000099RV';
                }
                else if(c.Product_Type__c=='CrowdTorch Ticketing' && c.Request_Type__c!='Strategic Support'){
                    c.ownerid = '00G00000006wAMC';                                // assign the case to TicketMob Client Support
                    //c.RecordTypeId = '0120000000099RV';
                }
                else if((c.Product_Type__c=='EMI' || c.Product_Type__c=='SpeedRFP') && c.Request_Type__c!='Strategic Support'){
